                        ...
                        <div class="card-body">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="mb-3 input-success">
                                    <label for="" class="mb-1">Nama Program</label>
                                    <input type="text" name="nama_program" value="Nama Program" class="form-control @error('nama_program') is-invalid @enderror">
                                    @error('nama_program')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3 input-success">
                                    <label for="" class="mb-1">Kode Program</label>
                                    <input type="text" name="kode_program" value="Kode Program" class="form-control @error('kode_program') is-invalid @enderror">
                                    @error('kode_program')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3 input-success">
                                    <label for="id_urusan" class="mb-1">Bidang <span class="text-danger">*</span></label>
