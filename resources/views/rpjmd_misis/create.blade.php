                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Form Input Misi</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('rpjmd_misis.store') }}" method="POST">
                                        @csrf
                                        <div class="input-group">
                                            <textarea class="form-control" rows="10" id="comment" name="nama_misi_rpjmd" placeholder="Isi Misi Bupati..." required></textarea>
                                        </div>
